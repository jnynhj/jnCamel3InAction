...
//        mock.message(0).exchangeProperty(Exchange.GROUPED_EXCHANGE).isInstanceOf(List.class);
        ...
        template.sendBodyAndHeader("direct:start", "I", "myId", 3);

        assertMockEndpointsSatisfied();

        // get the published exchange
        Exchange exchange = mock.getExchanges().get(0);
        Exchange exchange1 = mock.getExchanges().get(1);

//        System.out.println("JNDBG1: " + exchange.getIn());
//        System.out.println("JNDBG1: " + exchange.getIn().getBody());
//        System.out.println("JNDBG3: " + mock.message(0));
...
//        List list1 = exchange1.getProperty(Exchange.GROUPED_EXCHANGE, List.class);
//         assertEquals("Should contain the 3 arrived exchanges", 3, list1.size());
        List list1 = exchange1.getIn().getBody(List.class);
        ...
        Exchange a1 = (Exchange) list1.get(0);
        assertEquals("F", a1.getIn().getBody());
